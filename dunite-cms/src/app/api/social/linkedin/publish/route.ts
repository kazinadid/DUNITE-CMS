...
import { publishLinkedInPost } from '@/lib/social/linkedin/publisher';
import { formatZodError, linkedInPublishBodySchema } from '@/lib/social/linkedin/validator';
...
export async function POST(req: NextRequest) {
  ...
  const parsed = linkedInPublishBodySchema.safeParse(json);
  if (!parsed.success) {
