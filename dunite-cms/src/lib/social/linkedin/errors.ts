...
export class LinkedInTransientError extends LinkedInPublishError {
  constructor(code: string, message: string, sub?: number | null) {
    super(code, message, {
      ...
      user_facing_message:
        'LinkedIn is temporarily unavailable. We will retry automatically.',
    });
  }
}

export class LinkedInPermanentError extends LinkedInPublishError {
  constructor(
    code: string,
    message: string,
...
export class LinkedInTokenError extends LinkedInPublishError {
  constructor(code: string, message: string) {
    super(code, message, {
      ...
      failure_type: 'token',
      user_facing_message:
        'The LinkedIn connection expired. Reconnect LinkedIn in Integrations.',
    });
  }
}

export class LinkedInRateLimitError extends LinkedInPublishError {
  constructor(code: string, message: string) {
    super(code, message, {
      is_retryable: true,
      requires_reconnect: false,
      ...
      user_facing_message:
        'LinkedIn rate limit reached. We will retry after a delay.',
    });
  }
}
